...
class BankAccountMaxBalanceFinderTest {
    ...
    public static void main(String[] args) {
        ...
        // create transactions
        Transaction salaryPayment = new Transaction(1200);   // current 1200 max 1200
        Transaction rentPayment = new Transaction(300, ExpenseCategory.UTILITIES);   // current 900 max 1200
        Transaction taxReturnPayment = new Transaction(500); // current 1400 max 1400
        Transaction leasePayment = new Transaction(600, ExpenseCategory.LOANS);  // current 800 max 1400
