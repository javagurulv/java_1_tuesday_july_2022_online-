...
class TicTacToeVerticalDemo {
    public static void main(String[] args) {
        ...
        int playerOne = 0;
        boolean isGame1Player1Win = game.isWinPositionForVerticals(playerOneWinningGame1, playerOne);
        System.out.println("Expected win: Player One (0): " + isGame1Player1Win);

        boolean isGame2Player1Win = game.isWinPositionForVerticals(playerOneWinningGame2, playerOne);
        System.out.println("Expected win: Player One (0): " + isGame2Player1Win);

        boolean isGame3PlayerGame1Win = game.isWinPositionForVerticals(playerOneWinningGame3, playerOne);
        System.out.println("Expected win: Player One (0): " + isGame3PlayerGame1Win);

        int playerTwo = 1;
        boolean isGame4Player2Win = game.isWinPositionForVerticals(playerTwoWinningGame4, playerTwo);
        System.out.println("Expected win: Player Two (1): " + isGame4Player2Win);

        boolean isGame5Player2Win = game.isWinPositionForVerticals(playerTwoWinningGame5, playerTwo);
        System.out.println("Expected win: Player Two (1): " + isGame5Player2Win);

        boolean isGame6Player2Win = game.isWinPositionForVerticals(playerTwoWinningGame6, playerTwo);
